...
def upload():
    try:
        ...
        is_wakeword_check = request.headers.get('X-Wakeword-Check', 'false').lower() == 'true'
        
        print(f"First Chunk: {is_first_chunk}")
        print(f"Last Chunk: {is_last_chunk}")
        print(f"Session ID: {session_id}")
        print(f"Wakeword Check: {is_wakeword_check}")
            ...
            try:
                with open(wav_path, "rb") as af:
                    ...
                    if is_wakeword_check:
                        if "alexa" in user_text.lower():
                            print("✅ Wakeword algılandı!")
                            return make_response("wakeword_detected", 200)
                        else:
                            print("❌ Wakeword algılanmadı!")
                            # "Alexa yok" yanıtını seslendir
                            reply = "Alexa algılanmadı, lütfen tekrar deneyin."
                    ...
                    try:
                        ...
                        try:
                            ...
                            print(f"⚠️ MP3 silme hatası (önemsiz): {str(e)}")
                        ...
                        try:
                            ...
                            print(f"⚠️ WAV silme hatası (önemsiz): {str(e)}")
                ...
                try:
                    ...
                    print(f"⚠️ Dosya temizleme hatası (önemsiz): {str(e)}")
